 ...
 * since nextPlayer has clearTable field true and activate cards for ext player and playable cards
 * 
 ...
 * the event - UI clears the table and user fills up the point for game and submits it.  
 * 
